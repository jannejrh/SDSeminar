            ...
            begin
                if "Room Resource No." = '' then begin
                    ...
                    if(CurrFieldNo <> 0) then begin
                        if(SeminarRoom."JHE_Maximum Participants" <> 0) and
                           (SeminarRoom."JHE_Maximum Participants" < "Maximum Participants")
                        then begin
                            if Confirm(Text004, true,
                               "Maximum Participants",
                               SeminarRoom."JHE_Maximum Participants",
                               FieldCaption("Maximum Participants"),
                               "Maximum Participants",
                               SeminarRoom."JHE_Maximum Participants")
                          then
                                "Maximum Participants" := SeminarRoom."JHE_Maximum Participants";
                        end;
                    end;
                end;
            end;
